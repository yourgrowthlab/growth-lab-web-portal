      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">About Your Growth Lab</h2>
            <div className="h-1 w-16 bg-growthlab-teal mb-8"></div>
            ...
            <div className="flex items-center">
              <a href="#contact" className="text-growthlab-teal font-medium text-lg flex items-center group">
          ...
          <div className="grid gap-6">
            <h3 className="text-2xl font-bold mb-2 animate-fade-in">Our Core Values</h3>
            
            <div className="grid gap-6">
              {values.map((value, index) => (
                <Card key={index} className="border-none shadow-custom animate-fade-in" style={{animationDelay: `${0.2 * index}s`}}>
